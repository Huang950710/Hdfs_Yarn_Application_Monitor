...
public class YarnClusterApplication {
    ...
    public static void YARN_CLUSTER_APPLICATION_JSON(String COMPANY, String IP) {

        /**
         * ****************************************************************************************************************************************************************
         * Influxdb 数据赋值
         */
        Influxdb influxdb = new Influxdb("http://10.60.79.103:8086", "admin", "admin", "monitor");
        //创建inlfuxdb客户端对象
        ...
        while (true) {
            ...
            for (Object object : objects) {
                ...
                if (jsonObject.get("state").toString().equals("RUNNING") || jsonObject.get("state").toString().equals("ACCEPTED")) {
                    ...
                    setup.insert(tags, fields,"HDFS_YARN_APPLICATION_MONITOR");
                }
                fields.clear();
            }
            ...
            float l3 = (float) (EndTime - StartTime) / 1000;
            System.out.println(String.format("Time used %s ms", l3));
        }
    }
}
